...
# from Bot.plugins.CheckIn_CUIT.form import getFormValue
#
# """
# 登陆步骤说明
#
...
#         return f'学号：{studentID} {bs.findAll("span")[1].text}'
#     else:
#         return "打卡失败！"